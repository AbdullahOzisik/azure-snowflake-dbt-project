...
-- Geef je EIGEN gebruiker de transformer-role, zodat je met je eigen
-- Snowflake-account via dbt kunt verbinden (role TRANSFORMER).
-- Zoek eerst je gebruikersnaam met:  select current_user();
-- Vervang daarna YOUR_USERNAME hieronder door dat resultaat:
